...
Простые примеры подключения кошелька и вызова методов смарт-контракта (чтение и запись) в EVM-совместимых блокчейнах с использованием библиотек [wagmi](https://wagmi.sh/) и [viem](https://viem.sh/).
